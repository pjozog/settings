...
Debian_menu["Debian_Games_Strategy"] = {
	{"Battle for Wesnoth (1.8)","/usr/games/wesnoth-1.8-nolog","/usr/share/pixmaps/wesnoth-1.8-icon.xpm"},
}
Debian_menu["Debian_Games_Tools"] = {
	{"Battle for Wesnoth Editor (1.8)","/usr/games/wesnoth-1.8-nolog -e","/usr/share/pixmaps/wesnoth-1.8_editor-icon.xpm"},
}
